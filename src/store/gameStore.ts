...
type GameStatus = 'loading' | 'intro' | 'countdown' | 'playing' | 'finish' | 'champion' | 'outOfTrack';
...
interface GameState {
  ...
  setTrackBounds: (bounds: { minX: number; maxX: number; minZ: number; maxZ: number }) => void;
  resetRun: () => void;
  restartLevel: () => void;
